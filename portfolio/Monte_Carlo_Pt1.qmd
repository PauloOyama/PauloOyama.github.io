...
Considere o quadrado Q de vértices (-1, 1), (1 ,1), (1,-1) e (-1,-1) e
considere também o círculo C de raio 1, circunscrito em Q.
Seja A, o seguinte conjunto:
Ou seja, o conjunto A e formado pelos pontos do quadrado Q que estão dentro
da círculo C (x² + y² ≤ 1). Dessa forma, P(A) representa a probabilidade
de sortear um numero que esteja dentro do círculo. Logo,
e, por consequência,
...
#Gera um vetor de tamanho #100000 com todos os #campos preenchidos 
#com um valor entre -1 e 1
x <- runif(100000,-1,1)
y <- runif(100000,-1,1)
...
# fora;
# sum( circulo ) soma +1 nos indices TRUE e soma +0 
# nos de valor FALSE
...
piresultado <- 4*p
# piresultado =  3.13988
Veja como fica o plot dos valores do vetor booelano circulo,
plot (x, y, type = "n")
# Pontos que cairam dentro em laranja
points (x[ circulo ], y[ circulo ], col = " orange ", pch = 20,
cex = 0.5)
# Pontos que cairam fora em azul
points (x[! circulo ], y[! circulo ], col = " blue ", pch = 20,
cex = 0.5)
Referências:
